...
/*    $('.comment-show').on('click', '.pl-hf', function () {
        ...
        var fhHtml = ' <div class="hf-con pull-left"> \n' +
            '                                    <textarea class="form-control hf-con hf-input" placeholder="Please enter a comment&hellip;" name="rcontext"></textarea>\n' +
            '                                    <button click="addRemarkjq(this)" class="btn btn-group-lg btn-info" style="float: right">评论</button>\n' +
            '                                </div>';
        //显示回复
